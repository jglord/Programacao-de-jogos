...
public:
    Missile(Plane * plane, Image * img);							//	construtor 1
	Missile(Plane* plane, Image* img, float angle);					//	construtor 2
	Missile(Plane* plane, Image* img, float angle, float m);		// construtor 3
