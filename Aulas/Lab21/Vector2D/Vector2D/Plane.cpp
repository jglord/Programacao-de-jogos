...
Plane::Plane()
{
	...
	missile2 = new Image("Resources/Missile.png");
...
void Plane::Update()
{
    ...
    if (window->KeyPress(VK_SPACE))
    {
		...
		//Vector2D::scene->Add(new Missile(this, missile, Angle() + 5), STATIC);
		//Vector2D::scene->Add(new Missile(this, missile2, Angle() - 5), STATIC);
		
		// SAINDO DA ASA
		Vector2D::scene->Add(new Missile(this, missile2, Angle(), 30), STATIC);
		Vector2D::scene->Add(new Missile(this, missile2, Angle(), - 30), STATIC);
